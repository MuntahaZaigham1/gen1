...
import { UserroleExtendedService, UserroleDetailsExtendedComponent, UserroleListExtendedComponent, UserroleNewExtendedComponent } from './';
...
const entities = [
    UserroleDetailsExtendedComponent, UserroleListExtendedComponent, UserroleNewExtendedComponent 
  ]
@NgModule({
