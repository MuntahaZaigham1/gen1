...
import { UserpermissionExtendedService, UserpermissionDetailsExtendedComponent, UserpermissionListExtendedComponent, UserpermissionNewExtendedComponent } from './';
...
const entities = [
    UserpermissionDetailsExtendedComponent, UserpermissionListExtendedComponent, UserpermissionNewExtendedComponent 
  ]
@NgModule({
