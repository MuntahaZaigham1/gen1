...
import { UserExtendedService, UserDetailsExtendedComponent, UserListExtendedComponent, UserNewExtendedComponent } from './';
...
const entities = [
    UserDetailsExtendedComponent, UserListExtendedComponent, UserNewExtendedComponent 
  ]
@NgModule({
