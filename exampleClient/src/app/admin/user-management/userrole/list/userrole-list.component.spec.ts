...
import { IUserrole, UserroleService, UserroleDetailsComponent, UserroleListComponent,
	UserroleNewComponent } from '../';
...
describe('UserroleListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/userrole/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
