...
import { IUser, UserService, UserDetailsComponent, UserListComponent,
	UserNewComponent } from '../';
...
describe('UserListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/user/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
