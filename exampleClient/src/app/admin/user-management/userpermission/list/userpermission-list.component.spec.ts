...
import { IUserpermission, UserpermissionService, UserpermissionDetailsComponent, UserpermissionListComponent,
	UserpermissionNewComponent } from '../';
...
describe('UserpermissionListComponent', () => {
  ...
  let constData:IUserpermission[] = [
    ...
    {   
      ...
      userDescriptiveField: 'userName2',
    },
  ];
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/userpermission/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
