...
public class RolepermissionControllerTest extends DatabaseContainerConfig{
	...
	public static void cleanup() {
		...
		em.createNativeQuery("truncate table s2.rolepermission CASCADE").executeUpdate();
	...
	public void FindAll_SearchIsNotNullAndPropertyIsNotValid_ThrowException() throws Exception {
		...
		org.assertj.core.api.Assertions.assertThatThrownBy(() ->  mvc.perform(get("/rolepermission?search=rolepermissionpermissionId[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())).hasCause(new Exception("Wrong URL Format: Property rolepermissionpermissionId not found!"));
