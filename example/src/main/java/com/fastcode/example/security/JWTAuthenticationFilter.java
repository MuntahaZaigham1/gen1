...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public JWTAuthenticationFilter(AuthenticationManager authenticationManager,ApplicationContext ctx,IUserRepository userRepository) {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        User user = _userRepository.findByUserNameIgnoreCase(creds.getUserName());
